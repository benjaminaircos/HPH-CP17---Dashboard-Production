...
function compareAvecObjectifs(totalProduction, tauxRebuts, totalTempsArret) {
    ...
    kpiObjectifProd.textContent = `Objectif/équipe: ${objectifs.prodEquipe.toLocaleString()}`;
    
    if (totalProduction >= objectifs.prodEquipe) {
        ...
        const pourcentage = ((totalProduction / objectifs.prodEquipe) * 100).toFixed(0);
